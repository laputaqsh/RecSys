...
public class HGGC {
    ...
    private static String name = "HGGC";

    public static void main(String[] args) {
        int c = 2, z = 50, r = 50, topn = 10, iterNum = 50;
        HGGC hggc = new HGGC(c, z, r);
        hggc.init();
        hggc.setModel(iterNum);
        int[][] reclist = hggc.recommend(topn);
        Evaluation.evaluate(name, hggc.testset, reclist, topn);
    }
